...
//				+ "null";
	...
	public XmlStaticDatas(String source) throws Exception{
		super();
...
//				System.out.println(dest);
	...
	private Map setXmlCodeMap() {
		try {
			...
			// 先按$$$$$划分第一类节点
			String[] first = XmlStaticDatas.FIRSTCODESTRING.split("\\$\\$\\$\\$\\$");
...
//				System.out.println(str.split(spt[i])[0]);
	...
	private static String returnXmlString(int i) throws Exception{
		switch(i) {
			case 1:
				return XmlStaticDatas.FIRSTCODESTRING;
			case 2:
				return XmlStaticDatas.SECONDCODESTRING;
			case 3:
				return XmlStaticDatas.THIRDCODESTRING;
			case 4:
				return XmlStaticDatas.FOURCODESTRING;
			case 5:
				return XmlStaticDatas.FIVECODESTRING;
			default:
				return null;
		}
	}
